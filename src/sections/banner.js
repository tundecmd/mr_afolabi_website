...
import BannerImage from "assets/pexels-arabic.jpg";
                ...
                <Flex sx={styles.banner.row}>
                    <Box sx={styles.banner.col}>
                        <Box sx={styles.banner.content}>
                            ...
                            <Text as="p">
                                Assalamualaikum (Peace be Upon You) - Welcome to
                                Madinah Arabic We are a dedicated online
                                resource for all students around the world
                                seeking to learn Arabic. We hope to help you
                                through your Arabic learning journey and to make
                                it as easy and enjoyable as possible. We do
                                provide a 1-to-1 service where you or your
                                children can take private Arabic lessons with
                                highly qualified, ale or female, native Arabic
                                tutors. <br />
